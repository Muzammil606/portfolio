    ...
    <main>
      <section className="relative w-screen h-screen flex md:items-center justify-center">
        <div className="mt-40 md:mt-0 text-center">
          ...
          <div className="md:flex items-center justify-between md:px-1">
            <p className="text-xl text-center md:text-start">based in Mumbai, India</p>
            <div className="flex items-center justify-center md:justify-end gap-3 text-xl mt-4 md:mt-0">
              <a><RiLinkedinLine /></a>
              <a><RiGithubLine /></a>
              <a><RiFacebookLine /></a>
            </div>
          </div>
          <div className="flex items-center justify-center md:justify-between gap-5 mt-10">
            <a className="btn">hire me</a>
            <a className="btn outlined">download cv</a>
          </div>
